...
Script Purpose:
  ...
  -  Truncates the bronze tables beforer loading data
  -  Usese the COPY command to load data from csv files to bronze tables.
...
BEGIN
	...
	RAISE NOTICE '	- Total Load Duration: % seconds', ROUND(EXTRACT(EPOCH FROM (batch_end_time -
															batch_start_time))::numeric, 2);
	RAISE NOTICE '=========================================';
EXCEPTION
	WHEN OTHERS THEN
